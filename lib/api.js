 ...
 *
 */
exports.app.get('/customer', runAsync(async (req, res) => {
    console.log(req.query.customerId);
    const customerId = req.query.customerId.toString();
    res.send(await (0, customers_1.getCustomerById)(customerId));
}));
/**
 * Payment Intents
 */
exports.app.post('/customer', runAsync(async (req, res) => {
    console.log(req.body.name);
    res.send(await (0, customers_1.createCustomer)(req.body.name, req.body.email, req.body.params));
}));
/**
 * Payment Intents
 */
exports.app.post('/payments', runAsync(async ({ body }, res) => {
    res.send(await (0, payments_1.createPaymentIntent)(body.amount, body.currency));
}));
/**
 * Get customer by id
 */
exports.app.get('/customer', runAsync(async (req, res) => {
    res.send(await (0, customers_1.getCustomerById)(req['customerId']));
}));
/**
 * Get customer by id
 */
exports.app.get('/customer/search', runAsync(async (req, res) => {
    res.send(await (0, customers_1.getCustomerByEmail)(req.query.email.toString()));
}));
/**
