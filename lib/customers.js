...
exports.deleteCustomer = exports.createCustomer = exports.getCustomerByEmail = exports.getCustomerById = exports.getOrCreateCustomer = exports.listPaymentMethods = exports.createSetupIntent = void 0;
const _1 = require(".");
...
async function getCustomerByEmail(email) {
    console.log(email);
    return await _1.stripe.customers.search({
        query: `email:\'${email}\'`,
    });
}
